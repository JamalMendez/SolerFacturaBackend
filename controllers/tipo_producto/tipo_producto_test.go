...
func TestCreate(t *testing.T) {
	...
	t.Run("successful creation", func(t *testing.T) {
		...
		deletion := db_connection.TipoProducto{}
...
func TestGetAll(t *testing.T) {
	...
	t.Run("retrieve multiple records", func(t *testing.T) {
		...
		deletion1 := db_connection.TipoProducto{}
		deletion1.ID = tp1.ID
		if err != nil {
		...
		deletion2 := db_connection.TipoProducto{}
		deletion2.ID = tp2.ID
		if err != nil {
			t.Fatalf("Test setup failed: %v", err)
		}
...
func TestUpdate(t *testing.T) {
	...
	t.Run("non-existent ID", func(t *testing.T) {
		...
		if err == nil || err.Error() != "no se encontro ningun producto" {
...
func TestDelete(t *testing.T) {
	...
	t.Run("successful soft delete", func(t *testing.T) {
		...
		var deletedRecord db_connection.TipoProducto
		result := db_connection.Db.Unscoped().Where("id = ?", created.ID).First(&deletedRecord)
		if result.Error != nil {
			t.Fatal("Record should exist after soft delete")
		}
	...
	t.Run("non-existent ID", func(t *testing.T) {
		...
		expectedErr := "no se encontro ningun producto"
